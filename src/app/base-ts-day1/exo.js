...
import { MockDetails, MockDelivery } from './3waFsd40_Angular/typescript/jour1/source/chap3_Sources/05.2_Exercice_source/Cart/src/data/MockProducts';
let products = [];
...
MockDetails.forEach((detail) => {
    ...
    let detailToAdd = Object.assign(Object.assign({}, detail), deliveryRetrieved);
